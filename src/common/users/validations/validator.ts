...
// Check Validation Data User
export async function validationDataUnique(users): Promise<{ error, message?}> {
    if (users) {
...
export async function validationDataNotFound(userServices, id, message?): Promise<{ error, message?}> {
